...
public static final long CUDNN_RNN_PADDED_IO_ENABLED = (1L << 0);
...
public static native @Cast("cudnnStatus_t") int cudnnGetRNNDescriptor_v6(cudnnContext handle,
                         cudnnRNNStruct rnnDesc,
                         IntPointer hiddenSize,
                         IntPointer numLayers,
                         @ByPtrPtr cudnnDropoutStruct dropoutDesc,
...
public static native @Cast("cudnnStatus_t") int cudnnSetRNNPaddingMode(cudnnRNNStruct rnnDesc, @Cast("unsigned") int paddingMode);

public static native @Cast("cudnnStatus_t") int cudnnGetRNNPaddingMode(cudnnRNNStruct rnnDesc, @Cast("unsigned*") IntPointer paddingMode);
public static native @Cast("cudnnStatus_t") int cudnnGetRNNPaddingMode(cudnnRNNStruct rnnDesc, @Cast("unsigned*") IntBuffer paddingMode);
public static native @Cast("cudnnStatus_t") int cudnnGetRNNPaddingMode(cudnnRNNStruct rnnDesc, @Cast("unsigned*") int[] paddingMode);
...
public static final long CUDNN_ATTN_QUERYMAP_ONE_TO_ONE = (1L << 0); /* multiple Q-s map to multiple (K,V) sets when beam size > 1 */
public static final int CUDNN_ATTN_DISABLE_PROJ_BIASES = 0;         /* no biases in attention input and output projections */
public static final long CUDNN_ATTN_ENABLE_PROJ_BIASES = (1L << 1);
